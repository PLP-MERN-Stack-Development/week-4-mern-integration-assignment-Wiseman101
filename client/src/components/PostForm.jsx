...
//   useEffect(() => {
//     reset(editData || { title: "", content: "", category: "" });
//   }, [editData, reset]);
...
//         author: "Hillary Wafula", // Replace with dynamic user if needed
//       };

//       const res = editData
//         ? await updatePost(editData._id, fullData)
//         : await createPost(fullData);

//       setPosts(editData
//         ? posts.map(p => p._id === editData._id ? res.data : p)
//         : [res.data, ...posts]);
